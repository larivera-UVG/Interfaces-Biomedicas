...
%  
%% Probar todos los datos
% xs_prueba = scat_features';  % 10 datos al azar
% ys_prueba = net(xs_prueba);
% clases_prueba = vec2ind(ys_prueba); % contiene las etiquetas asignadas
% 
% figure(1); clf;
% s = confusionchart(labelWv,clases_prueba);
